        ...
        <form method="post" action="${pageContext.request.contextPath}/admin/user-add">
            ...
            <table border="1" cellpadding="8" cellspacing="0" style="min-width:900px;">
                <tr>
                    ...
                    <td><input name="username" value="" placeholder="a01" style="width:350px;">
                ...
                <tr>
                    <td><b>Password *</b></td>
                    <td><input type="password" name="password" placeholder="123456" style="width:350px;">
                        <span style=" color: red">${error}</span> 
                    </td>
                </tr>
                <tr>
                    <td><b>Full name *</b></td>
                    <td><input name="full_name" value="" placeholder="Nguyen Van A" style="width:350px;">
                        <span style=" color: red">${error}</span> 
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><b>Email</b></td>
                    <td><input name="email" value="" placeholder="a@gmail.com" style="width:350px;">
            ...
            <button type="button"
                    onclick="window.location.href = '${pageContext.request.contextPath}/admin/user-add'">
                Reset
            </button>
