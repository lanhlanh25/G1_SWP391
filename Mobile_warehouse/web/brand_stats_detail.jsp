                    ...
                    <td>
                        <c:choose>
                            <c:when test="${p.stockStatus == 'Out Of Stock'}">
                                <span class="badge badge-danger">${p.stockStatus}</span>
                            </c:when>
                            <c:when test="${p.stockStatus == 'Reorder Needed'}">
                                <span class="badge badge-warning">${p.stockStatus}</span>
                            </c:when>
                            <c:when test="${p.stockStatus == 'At ROP Level'}">
                                <span class="badge badge-info">${p.stockStatus}</span>
                            </c:when>
                            <c:otherwise>
                                <span class="badge badge-active">${p.stockStatus}</span>
                            </c:otherwise>
                        </c:choose>
                    </td>
                </tr>
