            ...
            <div class="d-flex align-items-end row">
                ...
                <div class="col-sm-5 text-center text-sm-left">
                    <div class="card-body pb-0 px-0 px-md-4">
                        <img src="${ctx}/assets/img/illustrations/man-with-laptop-light.png" height="140" alt="View Badge User" data-app-dark-img="illustrations/man-with-laptop-dark.png" data-app-light-img="illustrations/man-with-laptop-light.png" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <tr><td colspan="6" class="text-center p-5 text-muted">Everything is well stocked.</td></tr>
                            </c:otherwise>
                        </c:choose>
                    </tbody>
                </table>
                        ...
                        <c:choose>
                            <c:when test="${not empty dashboardRecentActivities}">
                                <c:forEach var="a" items="${dashboardRecentActivities}">
                                    <tr>
                                        <td><small class="text-muted"><i class="bx bx-time-five animate-pulse me-1"></i>${a.time}</small></td>
                                        <td>
                                            <c:choose>
                                                <c:when test="${fn:contains(a.type, 'Import')}">
                                                    <span class="text-success"><i class="bx bx-down-arrow-alt"></i> ${a.type}</span>
                                                </c:when>
                                                <c:otherwise>
                                                    <span class="text-info"><i class="bx bx-up-arrow-alt"></i> ${a.type}</span>
                                                </c:otherwise>
                                            </c:choose>
                                        </td>
                            ...
                            <c:otherwise>
                                <tr><td colspan="4" class="text-center p-4 text-muted">No recent activities recorded.</td></tr>
                            </c:otherwise>
                        </c:choose>
                    </tbody>
                </table>
