    ...
    <div class="card" style="margin-bottom:14px;">
      ...
      <div class="card-body">
        <div class="form-grid">
          ...
          <input class="input" type="date" name="expected_import_date" value="${param.expected_import_date}"/>
...
<script>
  ...
  function skuOptionsHtml(productId){let html='<option value="">Select SKU</option>';if(!productId)return html;document.getElementById("tplSkuOptions").querySelectorAll("option[data-product]").forEach(o=>{if(o.getAttribute("data-product")===String(productId))html+=o.outerHTML;});return html;}
  function addRow(){
    ...
    tb.appendChild(tr);renumber();recalcTotal();onProductChange(tr.querySelector('select[name="productId"]'));
  }
