...
<head>
    ...
    <style>
        ...
        .container{ max-width:800px; margin:0 auto; background:#fff; border:2px solid var(--line);
            border-radius:8px; padding:20px; }
        .header{ background:#f0f0f0; padding:10px 15px; border-bottom:2px solid var(--line);
            margin:-20px -20px 20px -20px; border-radius:6px 6px 0 0; }
        .header h2{ margin:0; font-size:18px; }
        .user-info{ font-size:13px; color:#666; margin-top:5px; }
        .form-group{ margin-bottom:15px; }
        .form-group label{ display:block; font-weight:700; margin-bottom:5px; font-size:13px; }
        .form-group input[type="text"], .form-group textarea{ width:100%; padding:8px; border:1px solid #333; box-sizing:border-box; font-size:13px; }
        .form-group textarea{ min-height:120px; resize:vertical; }
        .form-group input[readonly]{ background:#f0f0f0; color:#666; }
        .btn-group{ display:flex; gap:10px; margin-top:20px; }
        .btn{ padding:8px 16px; border:1px solid #333; background:#f6f6f6; cursor:pointer; font-size:13px; text-decoration:none; color:#111; }
        .btn-primary{ background:#1f6feb; color:#fff; border-color:#1f6feb; }
        .err{ background:#ffe9ee; border:1px solid #b00020; color:#b00020; padding:10px; margin-bottom:15px; border-radius:4px; font-size:13px; }
    </style>
</head>
<body>
