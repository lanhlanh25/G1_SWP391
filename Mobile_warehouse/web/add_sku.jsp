...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="${pageContext.request.contextPath}/manager/sku/add"
                  method="post"
                  autocomplete="off">
                ...
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <c:if test="${not empty errors.skuCode}">
                            <div class="err" style="color:red;font-weight:600">
                                ${errors.skuCode}
                            </div>
                        </c:if>
...
<script>
    ...
    function generateSku() {
        ...
        if (productCode && color && storage && ram && storage !== "custom" && ram !== "custom") {
            ...
            const sku =
                    productCode.trim() + "-" + color.trim().toUpperCase() + "-" + storage + "-" + ram;
