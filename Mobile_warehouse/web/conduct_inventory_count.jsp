                    ...
                    <table class="ic-tbl">
                      ...
                      <tbody>
                        <c:if test="${empty rows}">
                          <tr>
                            <td colspan="10" class="empty-row">No data found.</td>
                          </tr>
                        </c:if>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              <div class="d-inline-flex align-center gap-8">
                                <input class="counted-inp js-counted" type="number" name="countedQty" min="0"
                                  value="${r.countedQty}" data-system="${r.systemQty}" />
                                <span class="muted font-xs">Phone</span>
                              </div>
                            </td>
                  ...
                  <div class="paging-footer">
                    ...
                    <div class="paging">
                      ...
                      <c:choose>
                        <c:when test="${totalPages <= 5}">
                          <c:set var="pgS" value="1" />
                          <c:set var="pgE" value="${totalPages}" />
                        </c:when>
                        <c:when test="${pageNumber <= 3}">
                          <c:set var="pgS" value="1" />
                          <c:set var="pgE" value="5" />
                        </c:when>
                        <c:when test="${pageNumber >= totalPages - 2}">
                          <c:set var="pgS" value="${totalPages - 4}" />
                          <c:set var="pgE" value="${totalPages}" />
                        </c:when>
                        <c:otherwise>
                          <c:set var="pgS" value="${pageNumber - 2}" />
                          <c:set var="pgE" value="${pageNumber + 2}" />
                        </c:otherwise>
                      </c:choose>
                    ...
                    <div class="paging-size">
                      ...
                      <select class="select w-70"
                        onchange="location.href='${ctx}/inventory-count?q=${fn:escapeXml(q)}&brandId=${fn:escapeXml(brandId)}&page=1&pageSize='+this.value">
