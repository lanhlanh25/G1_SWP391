            ...
            <form method="post"
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input name="username" value="${v_username}" placeholder="e.g. staff02">
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="password" placeholder="e.g. 123456">
                            <span style="color: red">${error}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">Full name *</td>
                        <td><input name="full_name" value="${v_full_name}" placeholder="Nguyen Van A">
                            <span style="color: red">${error}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">Email*</td>
                        <td><input name="email" value="${v_email}" placeholder="a@gmail.com">
                            <span style="color: red">${error}</span>
