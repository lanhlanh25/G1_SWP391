...
public class RoleDAO {
   ...
   public List<Role> searchRoles(String keyword, Integer status, int page, int pageSize) {
...
public int countRoles(String keyword, Integer status) {
    StringBuilder sql = new StringBuilder();
...
public List<Role> searchRoles(String keyword, Integer status) {
    return searchRoles(keyword, status, 1, Integer.MAX_VALUE);
}
}
