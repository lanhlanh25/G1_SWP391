...
public class ExportReceiptPdf extends HttpServlet {
    ...
    // ===== Footer Event: footer luôn ở đáy mọi trang =====
    private static class FooterEvent extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            // nằm trong bottom margin => luôn dưới cùng mỗi trang
            float y = document.bottom() - 12; // chỉnh -6 / -12 / -18 tùy muốn sát đáy
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // ✅ tăng bottom margin để chừa chỗ footer
